...
public class Model {
    final public static int FIELD_CELL_SIZE = 20;
...
//    private LevelLoader levelLoader = new LevelLoader(Paths.get("..\\res\\levels.txt"));
    ...
    public void move(Direction direction) {
        ...
        switch (direction) {
            case LEFT:
                player.move(-GameObject.FIELD_CELL_SIZE, 0);
                break;
            case RIGHT:
                player.move(GameObject.FIELD_CELL_SIZE, 0);
                break;
            case UP:
                player.move(0, -GameObject.FIELD_CELL_SIZE);
                break;
            case DOWN:
                player.move(0, GameObject.FIELD_CELL_SIZE);
                break;
    ...
    public void checkCompletion() {
        ...
        if (count == gameObjects.getBoxes().size()) eventListener.levelCompleted(currentLevel);
    }
}
